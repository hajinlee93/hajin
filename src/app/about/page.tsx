      ...
      <AnimatePresence>
        {showInitialMessage && (
          ...
          >
            ...
            >
              프론트엔드 개발자 <span className="font-bold">이하진</span>
              입니다.
            </motion.span>
          </motion.div>
        )}
          ...
          >
            ...
            >
              ...
              <div className="flex flex-row gap-5 text-xs md:text-base mt-4 text-stone-600 w-full justify-center selection:bg-stone-300">
                <Link
                  href="https://github.com/hajinlee93"
                  target="_blank"
                ...
                <a
                  href="mailto: hyunkyoung04@naver.com"
                  className="hover:font-semibold"
                >
                  Email
                </a>
            ...
            >
              ...
              <AboutContent />
              <p className="text-sm text-stone-500 mt-2">update。 2024.06.01</p>
            </motion.div>
          </div>
          <ScrollDown />
        </motion.section>
